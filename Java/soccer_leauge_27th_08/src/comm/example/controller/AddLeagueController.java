...
import comm.example.factory.MyConnectiomFactory;
...
public class AddLeagueController extends HttpServlet {
	...
	protected void doProcess(HttpServletRequest request, HttpServletResponse response)
		...
		if (errMsgs.isEmpty()) {
			...
			javax.servlet.RequestDispatcher view = request.getRequestDispatcher("success.view");
			request.setAttribute("SUCCESS", new League(title, season, iYear));
			Connection connection=MyConnectiomFactory.getMySqlConnectionForHR();
			...
			javax.servlet.RequestDispatcher view = request.getRequestDispatcher("error.view");
			view.forward(request, response);
